    ...
    $.fn.socialSharePrivacy = function (userOptions) {
        ...
        return this.each(function () {
            ...
            if (facebook_on) {
                ...
                context.find('.facebook').css('width', '-=' + fb_width_sub);
